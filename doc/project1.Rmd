...
### Question 2: If the economy quickly declines as one of the common effects of the pendamic, will the disapproval ratio in the COVID/HEALTHCARE increase? How about the job approval rate?
...
### Question 3: Gender, Age,Education difference in Trump's Job Approval handling COVID-19. Who is the ideal candidate(Trump or Biden) in April 2020 for those people concern about the coronavirus?
...
"Time For Change" model created by Professor Alan Abramowitz is a model to predict popular vote in the presidential elections with:
  1. Presidential approval ratings
  2. Economic growth
  3. How long the White House has been controlled by one party instead of the other
...
My conclusion is that Trump may win without this pandemic considering the economic growth and his approval rating in the April 2020.  